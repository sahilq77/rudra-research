...
class ResponseData {
  ...
  List<List<ResponseList>> responseLists;
  ...
  factory ResponseData.fromJson(Map<String, dynamic> json) => ResponseData(
    ...
    surveySubmittedBy: SurveySubmittedBy.fromJson(json["survey_submitted_by"]),
    responseLists: List<List<ResponseList>>.from(
      json["response_lists"].map(
        (x) => List<ResponseList>.from(x.map((x) => ResponseList.fromJson(x))),
      ),
    ),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "response_lists": List<dynamic>.from(
      responseLists.map((x) => List<dynamic>.from(x.map((x) => x.toJson()))),
    ),
  };
}
