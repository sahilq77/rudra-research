...
List<GeCastResponse> geCastResponseFromJson(String str) => List<GeCastResponse>.from(json.decode(str).map((x) => GeCastResponse.fromJson(x)));

String geCastResponseToJson(List<GeCastResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
