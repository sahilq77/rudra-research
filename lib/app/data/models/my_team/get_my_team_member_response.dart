...
List<GetMyTeamMemberResponse> getMyTeamMemberResponseFromJson(String str) =>
    List<GetMyTeamMemberResponse>.from(
        json.decode(str).map((x) => GetMyTeamMemberResponse.fromJson(x)));

String getMyTeamMemberResponseToJson(List<GetMyTeamMemberResponse> data) =>
...
class GetMyTeamMemberResponse {
  ...
  factory GetMyTeamMemberResponse.fromJson(Map<String, dynamic> json) =>
      GetMyTeamMemberResponse(
        status: json["status"],
...
class TeamMemberData {
  ...
  factory TeamMemberData.fromJson(Map<String, dynamic> json) => TeamMemberData(
        ...
        teamMembersDetails: List<TeamMembersDetails>.from(
            json["team_members_details"]
                .map((x) => TeamMembersDetails.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "team_members_details":
            List<dynamic>.from(teamMembersDetails.map((x) => x.toJson())),
      };
}
...
class TeamMembersDetails {
  ...
  factory TeamMembersDetails.fromJson(Map<String, dynamic> json) =>
      TeamMembersDetails(
