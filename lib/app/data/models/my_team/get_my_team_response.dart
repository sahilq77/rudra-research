...
List<GetMyTeamResponse> getMyTeamResponseFromJson(String str) =>
    List<GetMyTeamResponse>.from(
        json.decode(str).map((x) => GetMyTeamResponse.fromJson(x)));

String getMyTeamResponseToJson(List<GetMyTeamResponse> data) =>
