...
List<GetValidatorSurveyResponse> getValidatorSurveyResponseFromJson(
        String str) =>
    List<GetValidatorSurveyResponse>.from(
      json.decode(str).map((x) => GetValidatorSurveyResponse.fromJson(x)),
    );

String getValidatorSurveyResponseToJson(
        List<GetValidatorSurveyResponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetValidatorSurveyResponse {
  String status;
  String message;
  ValidatorSurveyData data;

  GetValidatorSurveyResponse({
    required this.status,
    required this.message,
    required this.data,
  });

  factory GetValidatorSurveyResponse.fromJson(Map<String, dynamic> json) =>
      GetValidatorSurveyResponse(
        status: json["status"],
        message: json["message"],
        data: ValidatorSurveyData.fromJson(json["data"]),
      );
...
class ValidatorSurveyData {
  ValidatorSurveyInfo surveyInfo;
  ...
  factory ValidatorSurveyData.fromJson(Map<String, dynamic> json) =>
      ValidatorSurveyData(
        surveyInfo: ValidatorSurveyInfo.fromJson(json["survey_info"]),
        questionsAndAnswers: List<QuestionAnswer>.from(
          json["questions_and_answers"].map((x) => QuestionAnswer.fromJson(x)),
        ),
...
class ValidatorSurveyInfo {
  ...
  factory ValidatorSurveyInfo.fromJson(Map<String, dynamic> json) =>
      ValidatorSurveyInfo(
