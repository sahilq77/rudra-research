// lib/app/modules/executive_module/executive_survey_detail/executive_survey_question/executive_survey_question_view.dart
...
import 'executive_survey_question_controller.dart';

class ExecutiveSurveyQuestionView extends StatefulWidget {
  const ExecutiveSurveyQuestionView({super.key});

  @override
  State<ExecutiveSurveyQuestionView> createState() =>
      _ExecutiveSurveyQuestionViewState();
}

class _ExecutiveSurveyQuestionViewState
    extends State<ExecutiveSurveyQuestionView> {
  final ExecutiveSurveyQuestionController controller = Get.find();
                            ...
                            Row(
                              children: [
                                Obx(() => CircleAvatar(
                                  ...
                                  backgroundImage: AppUtility.userImage.value.isNotEmpty
                                      ? NetworkImage(AppUtility.userImage.value)
                                      : null,
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: AppStyle.labelSecondaryPoppinsGrey.responsive,
                                    ),
                                  ],
                                ),
                              ],
  ...
  Widget _buildTextField(
      Question question, ExecutiveSurveyQuestionController controller) {
