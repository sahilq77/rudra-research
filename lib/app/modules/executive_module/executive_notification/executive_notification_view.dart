...
class ExecutiveNotificationView extends StatefulWidget {
  const ExecutiveNotificationView({super.key});

  @override
  State<ExecutiveNotificationView> createState() =>
      _ExecutiveNotificationViewState();
}

class _ExecutiveNotificationViewState extends State<ExecutiveNotificationView> {
  final ExecutiveNotificationController controller = Get.find();
