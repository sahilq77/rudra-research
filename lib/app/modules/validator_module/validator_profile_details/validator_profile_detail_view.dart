...
import 'validator_profile_detail_controller.dart';

class ValidatorProfileDetailView extends StatefulWidget {
  const ValidatorProfileDetailView({super.key});

  @override
  State<ValidatorProfileDetailView> createState() =>
      _ValidatorProfileDetailViewState();
}

class _ValidatorProfileDetailViewState
    extends State<ValidatorProfileDetailView> {
  final ValidatorProfileDetailController controller = Get.find();
  ...
  Widget _buildProfileHeader() {
    return Obx(() => Column(
          children: [
            ...
            Text(
              'Hi , ${controller.profileDetails.value?.name ?? controller.userName}',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: ResponsiveHelper.spacing(16)),
          Obx(() => controller.isPerformanceLoading.value
              ? SizedBox(
