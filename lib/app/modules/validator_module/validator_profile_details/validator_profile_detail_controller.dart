...
class ValidatorProfileDetailController extends GetxController {
    ...
    try {
      ...
      if (!hasMoreData.value && !reset) {
        AppLogger.d('No more data to fetch',
            tag: 'ValidatorProfileDetailController');
        return;
      }
      ...
      if (response != null && response.isNotEmpty) {
        if (response[0].status == "true") {
          ...
          AppLogger.d('API returned status false: No profile data found',
              tag: 'ValidatorProfileDetailController');
          AppSnackbarStyles.showError(
              title: 'Error', message: 'No profile data found');
        }
      } else {
        hasMoreData.value = false;
        ...
        AppLogger.d('No response from server',
            tag: 'ValidatorProfileDetailController');
        AppSnackbarStyles.showError(
            title: 'Error', message: 'No response from server');
      }
    } on NoInternetException catch (e) {
      errorMessage.value = e.message;
      AppLogger.e('NoInternetException: ${e.message}',
          tag: 'ValidatorProfileDetailController', error: e);
      ...
      AppLogger.e('Unexpected error: $e',
          tag: 'ValidatorProfileDetailController', error: e);
      AppSnackbarStyles.showError(
          title: 'Error', message: 'Unexpected error: $e');
    } finally {
