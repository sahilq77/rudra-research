...
class ValidatorNotificationView extends StatefulWidget {
  const ValidatorNotificationView({super.key});

  @override
  State<ValidatorNotificationView> createState() =>
      _ValidatorNotificationViewState();
}
