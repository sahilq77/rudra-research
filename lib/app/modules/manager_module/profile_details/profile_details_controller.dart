...
import 'package:rudra/app/data/models/profile/upload_user_image_response.dart';
...
class ProfileDetailsController extends GetxController {
  ...
  void onEditProfile() {
    AppLogger.d('onEditProfile called', tag: 'ProfileDetailsController');
  ...
  Future<void> _uploadImage(File imageFile) async {
    try {
      isLoading.value = true;
      AppLogger.d('Uploading image...', tag: 'ProfileDetailsController');
